...
STATS_COLUMNS = [
        ...
        'team_2_leader_receiving_td','game_leader_scorer_points','game_leader_kicker_points',
    ]
...
def keywords():
    discount = ['clean_data','team_2_abbr','team_1_abbr','game_year','game_week','team_2_abbr','team_2_leader_rushing','team_2_leader_rushing_yds',
    'team_2_leader_rushing_td','team_2_leader_receiving', 'team_2_leader_receiving_yds', 'team_2_leader_receiving_td', 'game_headline', 'game_headline_annotated']
    keywords = []
    for keyword in COLUMNS:
        if keyword not in discount:
